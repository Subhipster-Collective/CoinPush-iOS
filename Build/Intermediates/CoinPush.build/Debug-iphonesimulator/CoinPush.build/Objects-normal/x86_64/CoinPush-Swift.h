...
SWIFT_CLASS("_TtC8CoinPush11AppDelegate")
...
SWIFT_CLASS("_TtC8CoinPush21CurrencyTableViewCell")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified deltaLabel;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC8CoinPush27CurrencyTableViewController")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified pushLabel;
@property (nonatomic, weak) IBOutlet UISwitch * _Null_unspecified pushSwitch;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified increaseLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified decreaseLabel;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified increaseValue;
...
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull fromOptions;
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull toOptions;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (void)touchesBegan:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
