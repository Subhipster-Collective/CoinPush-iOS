...
class CurrencyAdapter extends ArrayAdapter<CurrencyData>
{
    ...
    private class UpdateTask extends AsyncTask<CurrencyData, Void, Void>
    {
        @Override
        protected Void doInBackground(CurrencyData... data)
        {
    ...
    CurrencyAdapter(final Context context, final List<CurrencyData> data)
    {
        ...
        new UpdateTask().execute(data.toArray(new CurrencyData[0]));
    }
